          ...
          <Flex direction="column" css={{ gap: '$3' }}>
            <Flex css={{ color: '$gray11' }} align="center" justify="between">
              ...
              <Flex align="center" justify="end" css={{ gap: '$3' }}>
                ...
                activity.order?.source?.name !== 'Reservoir' ? (
                  <img
                    width="20px"
                    height="20px"
            ...
            <Flex align="center" justify="between">
              ...
              activity.type !== 'transfer' ? (
                <Flex
                  direction="column"
                  align="center"
                  css={{ minWidth: 'max-content', pl: '$2', gap: 5 }}
                >
                  <FormatCryptoCurrency
                    amount={
                  ...
                  <Text style="subtitle1">
                    {activity.price.currency?.symbol || 'ETH'}
                  </Text>
                </Flex>
              ) : (
                <span>-</span>
        ...
        activity.type !== 'transfer' ? (
          ...
          >
            <FormatCryptoCurrency
              ...
              textStyle="h6"
            />
            <Text style="h6">{activity.price.currency?.symbol || 'ETH'}</Text>
          </Flex>
        ) : (
          <span>-</span>
        )}
