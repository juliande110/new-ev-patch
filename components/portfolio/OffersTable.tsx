              ...
              <Flex justify="between" css={{ gap: '$2' }}>
                ...
                <Flex css={{alignItems: 'center', gap: 3}}>
                  <FormatCryptoCurrency
                    ...
                    logoHeight={14}
                  />
                  <Text style="subtitle3">{offer?.price?.currency?.symbol || 'ETH'}</Text>
                </Flex>
              </Flex>
            }
          >
            <Flex css={{alignItems: 'center', gap: 3}}>
              <FormatCryptoCurrency
                ...
                logoHeight={14}
              />
              <Text style="subtitle2">{offer?.price?.currency?.symbol || 'ETH'}</Text>
            </Flex>
          </Tooltip>
        </Flex>
        ...
        >
          <Flex css={{alignItems: 'center', gap: 3}}>
            <FormatCryptoCurrency
              ...
              logoHeight={14}
            />
            <Text style="subtitle1">{offer?.price?.currency?.symbol || 'ETH'}</Text>
          </Flex>
        </Tooltip>
      </TableCell>
      <TableCell>
