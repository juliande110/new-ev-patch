  ...
  render() {
    return (
      <Html>
        ...
        {/* Favicon */}
        <link rel="shortcut icon" type="image/svg+xml" href="/emblemIcon.svg" />

        {/* Reservoir meta tags */}
        <meta property="reservoir:title" content="Emblem Markets" />
        <meta property="reservoir:icon" content="/SteelVault.png" />
        <meta
